...
//#endif
  ...
  if (AT_RESP_ERR_NO_RESP == SendATCmdWaitResp(F("AT"), 900, 200, F("OK"), 5)) {		//check power
	...
	if (AT_RESP_ERR_DIF_RESP == SendATCmdWaitResp(F("AT"), 900, 200, F("OK"), 5)) {		//check OK
